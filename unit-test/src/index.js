...
function makeNumberInput() {
  ...
  cardNumber.addEventListener('blur', () => {
    cardValidation(cardNumber.value)
...
function makeCvvInput() {
  cvv = el('input', { class: 'cvv-number', placeholder: 'XXX' });
  Inputmask({ regex: '\\d{3}', placeholder: '' }).mask(cvv);
...
export function cardValidation(number) {
...
export function cvvValidation(number) {
